...
checkType ctx (TVar x) ty = do
  tvar ← inferVar ctx x
  -- tvar has type Σ (t ∈ Type α) (TyTerm ctx (TVar x) t) 
...
checkType ctx _ _ = tcError "TODO: implement this"
...
inferType ctx _ = tcError "TODO: implement this case of inferType"
